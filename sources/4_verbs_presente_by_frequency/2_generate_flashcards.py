"""
Generate flashcard CSV for Italian verbs — presente tense.

Input:  sources/4_verbs_presente_by_frequency/verbs_conjugated.csv
...
OUTPUT_CSV = PROJECT_ROOT / "spreadsheets" / "verbs_presente.csv"
