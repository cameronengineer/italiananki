"""
Conjugate Italian verb infinitives in the presente indicativo tense.
...
Writes: sources/4_verbs_presente_by_frequency/verbs_conjugated.csv
...
Usage (from project root, with .venv activated):
    python sources/4_verbs_presente_by_frequency/1_conjugate.py
"""
...
OUTPUT_DIR = PROJECT_ROOT / "sources" / "4_verbs_presente_by_frequency"
...
BATCH_SIZE       = 20    # verbs per API call (conjugations are larger responses)
RETRY_DELAY      = 5
MAX_RETRIES      = 3
        ...
        "items": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "io": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'io' (1st person singular)",
                    },
                    "io_english": {
                        "type": "string",
                        "description": "English translation of the 'io' form (e.g. 'I eat')",
                    },
                    "tu": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'tu' (2nd person singular)",
                    },
                    "tu_english": {
                        "type": "string",
                        "description": "English translation of the 'tu' form (e.g. 'you eat')",
                    },
                    "lui_lei": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'lui/lei' (3rd person singular)",
                    },
                    "lui_lei_english": {
                        "type": "string",
                        "description": "English translation of the 'lui/lei' form (e.g. 'he/she eats')",
                    },
                    "noi": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'noi' (1st person plural)",
                    },
                    "noi_english": {
                        "type": "string",
                        "description": "English translation of the 'noi' form (e.g. 'we eat')",
                    },
                    "voi": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'voi' (2nd person plural)",
                    },
                    "voi_english": {
                        "type": "string",
                        "description": "English translation of the 'voi' form (e.g. 'you all eat')",
                    },
                    "loro": {
                        "type": "string",
                        "description": "Presente indicativo conjugation for 'loro' (3rd person plural)",
                    },
                    "loro_english": {
                        "type": "string",
                        "description": "English translation of the 'loro' form (e.g. 'they eat')",
                    },
                },
...
def conjugate_batch(verbs: list[dict[str, str]], api_key: str) -> dict[str, dict[str, str]]:
    ...
    presente indicativo tense for all six pronouns.

    Returns a dict keyed by infinitive:
        {"io": ..., "io_english": ..., "tu": ..., "tu_english": ..., "lui/lei": ...,
         "lui/lei_english": ..., "noi": ..., "noi_english": ...,
    ...
    prompt = (
        ...
        "presente indicativo (present indicative) tense for all six pronouns: "
        "io, tu, lui/lei, noi, voi, loro.\n\n"
        "For each pronoun form also provide the English translation "
        "(e.g. io → 'I eat', tu → 'you eat', lui/lei → 'he/she eats', "
        "noi → 'we eat', voi → 'you all eat', loro → 'they eat').\n\n"
...
def main() -> None:
    ...
    # Build english lookup for writing
    ...
    for batch_num, start in enumerate(range(0, len(remaining), BATCH_SIZE), 1):
        ...
        # Append new results to the output file incrementally
