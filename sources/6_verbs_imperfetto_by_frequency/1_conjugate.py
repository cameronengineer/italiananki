"""
Conjugate Italian verb infinitives in the imperfetto tense.
...
Writes: sources/6_verbs_imperfetto_by_frequency/verbs_conjugated.csv
...
Usage (from project root, with .venv activated):
    python sources/6_verbs_imperfetto_by_frequency/1_conjugate.py
"""
...
OUTPUT_DIR   = PROJECT_ROOT / "sources" / "6_verbs_imperfetto_by_frequency"
...
RETRY_DELAY      = 5
MAX_RETRIES      = 3
MAX_CONJUGATIONS = 10    # stop after this many total conjugations (including already-done)
        ...
        "items": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "io": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'io' (e.g. 'mangiavo', 'ero')",
                    },
                    "io_english": {
                        "type": "string",
                        "description": "English translation of the 'io' form (e.g. 'I was eating', 'I used to eat')",
                    },
                    "tu": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'tu' (e.g. 'mangiavi', 'eri')",
                    },
                    "tu_english": {
                        "type": "string",
                        "description": "English translation of the 'tu' form (e.g. 'you were eating')",
                    },
                    "lui_lei": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'lui/lei' (e.g. 'mangiava', 'era')",
                    },
                    "lui_lei_english": {
                        "type": "string",
                        "description": "English translation of the 'lui/lei' form (e.g. 'he/she was eating')",
                    },
                    "noi": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'noi' (e.g. 'mangiavamo', 'eravamo')",
                    },
                    "noi_english": {
                        "type": "string",
                        "description": "English translation of the 'noi' form (e.g. 'we were eating')",
                    },
                    "voi": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'voi' (e.g. 'mangiavate', 'eravate')",
                    },
                    "voi_english": {
                        "type": "string",
                        "description": "English translation of the 'voi' form (e.g. 'you all were eating')",
                    },
                    "loro": {
                        "type": "string",
                        "description": "Imperfetto conjugation for 'loro' (e.g. 'mangiavano', 'erano')",
                    },
                    "loro_english": {
                        "type": "string",
                        "description": "English translation of the 'loro' form (e.g. 'they were eating')",
                    },
                },
...
def conjugate_batch(verbs: list[dict[str, str]], api_key: str) -> dict[str, dict[str, str]]:
    ...
    imperfetto tense for all six pronouns, with English translations.
    ...
    prompt = (
        ...
        "imperfetto (imperfect) tense for all six pronouns: io, tu, lui/lei, noi, voi, loro.\n\n"
        "For each pronoun form also provide the English translation using the "
        "imperfect construction (e.g. io → 'I was eating' / 'I used to eat', "
        "lui/lei → 'he/she was eating').\n\n"
