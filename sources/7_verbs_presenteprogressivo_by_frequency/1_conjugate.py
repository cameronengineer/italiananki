"""
Conjugate Italian verb infinitives in the presente progressivo tense.

Forms: stare (present) + gerundio  →  e.g. "sto imparando", "stai mangiando"

For each verb the AI returns all six pronoun forms:
  io, tu, lui/lei, noi, voi, loro

Reads:  sources/3_verbs_infinito_by_frequency/verbs_translated.csv
Writes: sources/7_verbs_presenteprogressivo_by_frequency/verbs_conjugated.csv

Output columns: italian, english, io, io_english, tu, tu_english, lui/lei, lui/lei_english, noi, noi_english, voi, voi_english, loro, loro_english

Usage (from project root, with .venv activated):
    python sources/7_verbs_presenteprogressivo_by_frequency/1_conjugate.py
"""
...
OUTPUT_DIR   = PROJECT_ROOT / "sources" / "7_verbs_presenteprogressivo_by_frequency"
        ...
        "items": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "io": {
                        "type": "string",
                        "description": "Presente progressivo for 'io' (e.g. 'sto mangiando')",
                    },
                    "io_english": {
                        "type": "string",
                        "description": "English translation of the 'io' form (e.g. 'I am eating')",
                    },
                    "tu": {
                        "type": "string",
                        "description": "Presente progressivo for 'tu' (e.g. 'stai mangiando')",
                    },
                    "tu_english": {
                        "type": "string",
                        "description": "English translation of the 'tu' form (e.g. 'you are eating')",
                    },
                    "lui_lei": {
                        "type": "string",
                        "description": "Presente progressivo for 'lui/lei' (e.g. 'sta mangiando')",
                    },
                    "lui_lei_english": {
                        "type": "string",
                        "description": "English translation of the 'lui/lei' form (e.g. 'he/she is eating')",
                    },
                    "noi": {
                        "type": "string",
                        "description": "Presente progressivo for 'noi' (e.g. 'stiamo mangiando')",
                    },
                    "noi_english": {
                        "type": "string",
                        "description": "English translation of the 'noi' form (e.g. 'we are eating')",
                    },
                    "voi": {
                        "type": "string",
                        "description": "Presente progressivo for 'voi' (e.g. 'state mangiando')",
                    },
                    "voi_english": {
                        "type": "string",
                        "description": "English translation of the 'voi' form (e.g. 'you all are eating')",
                    },
                    "loro": {
                        "type": "string",
                        "description": "Presente progressivo for 'loro' (e.g. 'stanno mangiando')",
                    },
                    "loro_english": {
                        "type": "string",
                        "description": "English translation of the 'loro' form (e.g. 'they are eating')",
                    },
                },
                "required": [
                    "italian",
...
def conjugate_batch(verbs: list[dict[str, str]], api_key: str) -> dict[str, dict[str, str]]:
    ...
    presente progressivo tense for all six pronouns.

    Returns a dict keyed by infinitive with all six forms and their English translations.
    """
    verb_list = "\n".join(f"- {v['italian']}" for v in verbs)
    prompt = (
        "Conjugate each of the following Italian verb infinitives in the "
        "presente progressivo (present continuous) tense for all six pronouns: "
        "io, tu, lui/lei, noi, voi, loro.\n\n"
        "The presente progressivo is formed with the present tense of 'stare' "
        "plus the gerundio of the verb "
        "(e.g. mangiare → sto mangiando, stai mangiando, sta mangiando, "
        "stiamo mangiando, state mangiando, stanno mangiando).\n\n"
        "For each pronoun form also provide the English translation "
        "(e.g. io → 'I am eating', tu → 'you are eating', lui/lei → 'he/she is eating', "
        "noi → 'we are eating', voi → 'you all are eating', loro → 'they are eating').\n\n"
    ...
    empty = {"io": "", "io_english": "", "tu": "", "tu_english": "", "lui/lei": "", "lui/lei_english": "", "noi": "", "noi_english": "", "voi": "", "voi_english": "", "loro": "", "loro_english": ""}
    return {v["italian"]: empty for v in verbs}
...
def main() -> None:
    ...
    for batch_num, start in enumerate(range(0, len(remaining), BATCH_SIZE), 1):
        ...
        mode = "w" if (batch_num == 1 and not done) else "a"
        write_header = batch_num == 1 and not done
    ...
    print(f"Total rows: {len(done) + len(remaining)}")
